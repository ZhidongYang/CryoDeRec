...
def parse_args():
    ...
    parser.add_argument('--dataroot', default=None, help='path to dataset (required only for training)')
    parser.add_argument('--dataset', type=str, default='mnist', choices=['mnist', 'fashion-mnist', 'cifar', 'stl10','custom'],
    ...
    # parameters for tilt noise generator
    parser.add_argument('--tilt_angles', type=int, default=121, help='The number of maximum tilts')
    parser.add_argument('--patch_size', type=int, default=256, help='Size of originally generated patch')
    parser.add_argument('--image_size', type=int, default=1024, help='Size of noiseless tilt image')
    parser.add_argument('--save_path', type=str, default='./synthesized_noise_121_tilts', help='path to synthesized noise')
